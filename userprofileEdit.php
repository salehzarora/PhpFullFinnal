    ...
    <div class="card mb-3" style="width: 900px;" >
                ...
                <hr>
                  ...
                  <div class="row">
                    ...
                    <input type="file"  name="imgc" value="<?php echo $row2['img']; ?>">  </input> 

                    <input type="hidden" value="<?php echo  $_SESSION['userid']; ?>" name="userid">

                    <button class="btn btn-info " name="submitc" >  Confirm </button>
                  ...
                  <form id="contact-form" role="form" action="includes/userprofileEdit.inc.php"  method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input type="text" value="  <?php echo $row2['usersName']; ?>" name="usersName">  </input>                
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <input type="hidden" value="<?php echo  $_SESSION['userid']; ?>" name="usersId">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input type="text" value="  <?php echo $row2['Phone']; ?>" name="Phone">  </input>                
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input type="text" value="  <?php echo $row2['usersEmail']; ?>" name="Email">  </input>                
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                   <button class="btn btn-info " name="Confirm" >  Confirm </button>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="-mx-4 flex flex-wrap">
      <div class="w-full px-4">
        <div class="max-w-full overflow-x-auto">
          <table class="w-full table-auto" style="margin-right: 80px; margin-left: -80px; margin-top: -160px; ">
            <thead>
			  ...
			  <?php } }else echo "Ops you dont have any training" ?>
