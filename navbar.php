...
if(isset($_SESSION["userid"]) && !isset($_SESSION["isWorker"]) || !isset($_SESSION["userid"])  ){ 
?>
  ...
  <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-white u-text-white" href="LOCATION.php" style="padding: 10px 38px;">LOCATIONS</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-white u-text-white" href="Contacts.php" style="padding: 10px 38px;">CONTACTS</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-white u-text-white" href="PersonalTrainer.php" style="padding: 10px 38px;">PERSONAL TRAINERS</a>
        ...
        <a href="userprofile.php" class="u-image u-logo u-image-2" >
          ...
          <!-- u-text-1 -->
          <h6 class="u-text u-text-default " >
          <?php
            if(isset($_SESSION["useruid"])){
              echo "<a href='includes/logout.inc.php'           style='margin-left: 1000px;   ' >";
              ?><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
              log out</a>
              <?php
            }
            else{
               echo "<a href='login.php' style='margin-left: 1000px;'>";
      ...
      <?php }else header("location: 500.php"); ?>
      </body>
